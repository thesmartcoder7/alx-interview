#!/usr/bin/python3
"""this Performs log parsing from stdin"""
...
def print_stats(dict, file_s):
    """this Prints the status code and the number of times they appear"""
    ...
    try:
        for line in sys.stdin:
            ...
            if counter != 0 and counter % 10 == 0:
                print_stats(statusC_counter, file_size)
            counter = counter + 1
            try:
